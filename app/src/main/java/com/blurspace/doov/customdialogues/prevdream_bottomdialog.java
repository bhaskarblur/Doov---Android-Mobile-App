...
public class prevdream_bottomdialog extends BottomSheetDialogFragment {
    DatabaseReference dbref=FirebaseDatabase.getInstance().getReference("Users");
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable  ViewGroup container, Bundle savedInstanceState) {
        View v=inflater.inflate(R.layout.prevdream_bottomdialog,container,false);
        ImageView dreamimg= v.findViewById(R.id.prevdreamdialogimg);
        TextView dreaname=v.findViewById(R.id.prevdreamdialogname);
        TextView dreamfield=v.findViewById(R.id.prevdreamdialogfield);
        Button startdream=v.findViewById(R.id.prevdreamrest);
        ImageView lovedbtn=v.findViewById(R.id.prevdream_lovebtn);
        ImageView notlovedbtn=v.findViewById(R.id.prevdream_notlovebtn);
        ImageView sharebtn=v.findViewById(R.id.prevdream_sharebtn);

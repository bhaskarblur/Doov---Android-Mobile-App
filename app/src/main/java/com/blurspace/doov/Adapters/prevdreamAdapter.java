...
import com.blurspace.doov.customdialogues.prevdream_bottomdialog;
import com.blurspace.doov.customdialogues.userdream_bottomdialog;
import com.squareup.picasso.Picasso;

import java.util.List;

public class prevdreamAdapter extends RecyclerView.Adapter<prevdreamAdapter.viewHolder> {
    public prevdreamAdapter(Context mcontext, List<DreamsModel> dreamsList) {
    ...
    public viewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(mcontext).inflate(R.layout.prevdreams_lay,parent,false);
    ...
    public void onBindViewHolder(@NonNull viewHolder holder, int position) {
        ...
        holder.card.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                com.blurspace.doov.customdialogues.prevdream_bottomdialog userdream_bottomdialog=new prevdream_bottomdialog();
    ...
    public class viewHolder extends RecyclerView.ViewHolder {
        ...
        public viewHolder(@NonNull View itemView) {
            super(itemView);
            img=itemView.findViewById(R.id.prevdreamimg);
            name=itemView.findViewById(R.id.prevdreamname);
            field=itemView.findViewById(R.id.prevdreamfield);
            card=itemView.findViewById(R.id.prevdreamcard);
            resbtn=itemView.findViewById(R.id.prevdreamrest);
        }
    }
}
